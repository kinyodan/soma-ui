  ...
  <div class="container" id="container">
    <div class="form-container sign-up-container">
      <form action="#">
        ...
        <input v-model="confirm_pass" type="password" placeholder="Confirm Password"/>
        <button @click.prevent="signUpsubmit" >Sign Up</button>
      </form>
    </div>
    <div class="form-container sign-in-container">
      <form action="#">
        ...
        <input v-model="email" type="email" id="email-sign-in" placeholder="Email"/>
        <input v-model="password" type="password" placeholder="Password"/>
        <a href="#">Forgot your password?</a>
        <button @click.prevent="signInsubmit">Sign In</button>
      </form>
    </div>
...
.overlay {
background: #17191e;
background: -webkit-linear-gradient(to right, #273659, #17191e);
background: linear-gradient(to right, #273659, #17191e);
