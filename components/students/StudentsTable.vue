  ...
  <div>
    ...
    >
      <template slot-scope="props">
        ...
        <b-table-column label="First Name" field="name" sortable>
          <nuxt-link
            :to="{
              path: '/students/' + props.row.uuid,
        ...
        <b-table-column label="Email" field="progress_steps" sortable>
          {{ props.row.email }}
        </b-table-column>
        <b-table-column
...
export default {
  name: 'StudentsTable',
  components: { ModalBox },
  props: ['students_list', 'dataUrl', 'checkable'],
  data() {
    return {
      isModalActive: false,
      trashObject: null,
